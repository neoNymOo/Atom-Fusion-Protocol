...
public class VariablesAFP {
    public static class MapVariables extends WorldSavedData {
        public static final String DATA_NAME = "afp_mapvars";
        public MapVariables() {
            super(DATA_NAME);
        }
        ...
        public void syncData(World world) {
            this.markDirty();
            if (world.isRemote) {
                AtomFusionProtocol.PACKET_HANDLER.sendToServer(new WorldSavedDataSyncMessage(0, this));
            } else {
                AtomFusionProtocol.PACKET_HANDLER.sendToAll(new WorldSavedDataSyncMessage(0, this));
            }
        }
    ...
    public static class WorldVariables extends WorldSavedData {
        public static final String DATA_NAME = "afp_worldvars";
        ...
        public void syncData(World world) {
            this.markDirty();
            if (world.isRemote) {
                AtomFusionProtocol.PACKET_HANDLER.sendToServer(new WorldSavedDataSyncMessage(1, this));
            } else {
                AtomFusionProtocol.PACKET_HANDLER.sendToDimension(new WorldSavedDataSyncMessage(1, this), world.provider.getDimension());
            }
        }
    ...
    public static class WorldSavedDataSyncMessageHandler implements IMessageHandler<WorldSavedDataSyncMessage, IMessage> {
        ...
        private void syncData(WorldSavedDataSyncMessage message, MessageContext context, World world) {
            ...
            if (message.type == 0) {
                ...
                world.getMapStorage().setData(WorldVariables.DATA_NAME, message.data);
            }
        }
    }
