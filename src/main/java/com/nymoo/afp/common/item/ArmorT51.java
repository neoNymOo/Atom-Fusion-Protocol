...
public class ArmorT51 extends ModElementRegistry.ModElement {
    ...
    public void registerModels(ModelRegistryEvent event) {
        ...
        ModelLoader.setCustomMeshDefinition(chestplate, stack -> {
            ...
            String modelPath = jetpack ? "afp:t51/t51_chestplate_jetpack" : "afp:t51/t51_chestplate";
        ...
        ModelLoader.registerItemVariants(
                ...
                new ModelResourceLocation("afp:t51/t51_chestplate_jetpack", "inventory")
        );
    }
    ...
    public class ItemT51Helmet extends ItemArmor implements IPowerArmor {
        ...
        public ModelBiped getArmorModel(EntityLivingBase living, ItemStack stack, EntityEquipmentSlot slot, ModelBiped defaultModel) {
            if (helmetModel == null) {
                helmetModel = new PowerArmorModel(0, "t51", false, false);
            }
            return helmetModel;
        }
        ...
        public ModelBiped getArmorModel(EntityLivingBase living, ItemStack stack, EntityEquipmentSlot slot, ModelBiped defaultModel) {
            ...
            if (jetpack) {
                if (chestplateModelJet == null) {
                    chestplateModelJet = new PowerArmorModel(1, "t51", true, false);
                }
                return chestplateModelJet;
            } else {
                if (chestplateModel == null) {
                    chestplateModel = new PowerArmorModel(1, "t51", false, false);
                }
    ...
    public class ItemT51Leggings extends ItemArmor implements IPowerArmor {
        ...
        public ModelBiped getArmorModel(EntityLivingBase living, ItemStack stack, EntityEquipmentSlot slot, ModelBiped defaultModel) {
            if (leggingsModel == null) {
                leggingsModel = new PowerArmorModel(2, "t51", false, false);
            }
    ...
    public class ItemT51Boots extends ItemArmor implements IPowerArmor {
        ...
        public ModelBiped getArmorModel(EntityLivingBase living, ItemStack stack, EntityEquipmentSlot slot, ModelBiped defaultModel) {
            if (bootsModel == null) {
                bootsModel = new PowerArmorModel(3, "t51", false, false);
            }
            return bootsModel;
        }
