...
public class ArmorX02Broken extends ModElementRegistry.ModElement {

    @GameRegistry.ObjectHolder("afp:x02_helmet_broken")
    public static final Item helmet = null;
    @GameRegistry.ObjectHolder("afp:x02_chestplate_broken")
    public static final Item chestplate = null;
    @GameRegistry.ObjectHolder("afp:x02_leggings_broken")
    public static final Item leggings = null;
    @GameRegistry.ObjectHolder("afp:x02_boots_broken")
    ...
    public ArmorX02Broken(ModElementRegistry instance) {
        super(instance, 9);
    }
    ...
    public void initElements() {
        ...
        elements.items.add(() -> new ItemX02Helmet(enuma, 0, EntityEquipmentSlot.HEAD)
                .setTranslationKey("x02_helmet_broken")
                .setRegistryName("x02_helmet_broken")
                .setCreativeTab(TabPowerArmor.tab));

        elements.items.add(() -> new ItemX02Chestplate(enuma, 0, EntityEquipmentSlot.CHEST)
                .setTranslationKey("x02_chestplate_broken")
                .setRegistryName("x02_chestplate_broken")
                .setCreativeTab(TabPowerArmor.tab));

        elements.items.add(() -> new ItemX02Leggings(enuma, 0, EntityEquipmentSlot.LEGS)
                .setTranslationKey("x02_leggings_broken")
                .setRegistryName("x02_leggings_broken")
                .setCreativeTab(TabPowerArmor.tab));

        elements.items.add(() -> new ItemX02Boots(enuma, 0, EntityEquipmentSlot.FEET)
                .setTranslationKey("x02_boots_broken")
                .setRegistryName("x02_boots_broken")
                .setCreativeTab(TabPowerArmor.tab));
    }
    ...
    public void registerModels(ModelRegistryEvent event) {
        ModelLoader.setCustomModelResourceLocation(helmet, 0, new ModelResourceLocation("afp:x02/x02_helmet_broken", "inventory"));
        ModelLoader.setCustomModelResourceLocation(chestplate, 0, new ModelResourceLocation("afp:x02/x02_chestplate_broken", "inventory"));
        ModelLoader.setCustomModelResourceLocation(leggings, 0, new ModelResourceLocation("afp:x02/x02_leggings_broken", "inventory"));
        ModelLoader.setCustomModelResourceLocation(boots, 0, new ModelResourceLocation("afp:x02/x02_boots_broken", "inventory"));
    }
    ...
    public class ItemX02Helmet extends ItemArmor implements IPowerArmor {
        ...
        public ModelBiped getArmorModel(EntityLivingBase living, ItemStack stack, EntityEquipmentSlot slot, ModelBiped defaultModel) {
            if (helmetModel == null) {
                helmetModel = new PowerArmorModel(0, "x02", false, true);
            }
            return helmetModel;
        }
    ...
    public class ItemX02Chestplate extends ItemArmor implements IPowerArmor {
        ...
        public ModelBiped getArmorModel(EntityLivingBase living, ItemStack stack, EntityEquipmentSlot slot, ModelBiped defaultModel) {
            if (chestplateModel == null) {
                chestplateModel = new PowerArmorModel(1, "x02", false, true);
            }
    ...
    public class ItemX02Leggings extends ItemArmor implements IPowerArmor {
        ...
        public ModelBiped getArmorModel(EntityLivingBase living, ItemStack stack, EntityEquipmentSlot slot, ModelBiped defaultModel) {
            if (leggingsModel == null) {
                leggingsModel = new PowerArmorModel(2, "x02", false, true);
            }
    ...
    public class ItemX02Boots extends ItemArmor implements IPowerArmor {
        ...
        public ModelBiped getArmorModel(EntityLivingBase living, ItemStack stack, EntityEquipmentSlot slot, ModelBiped defaultModel) {
            if (bootsModel == null) {
                bootsModel = new PowerArmorModel(3, "x02", false, true);
            }
            return bootsModel;
        }
