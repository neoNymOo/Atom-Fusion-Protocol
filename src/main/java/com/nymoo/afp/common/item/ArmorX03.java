...
public class ArmorX03 extends ModElementRegistry.ModElement {
    ...
    public void registerModels(ModelRegistryEvent event) {
        ...
        ModelLoader.setCustomMeshDefinition(chestplate, stack -> {
            ...
            String modelPath = jetpack ? "afp:x03/x03_chestplate_jetpack" : "afp:x03/x03_chestplate";
        ...
        ModelLoader.registerItemVariants(
                ...
                new ModelResourceLocation("afp:x03/x03_chestplate_jetpack", "inventory")
        );
    }
    ...
    public class ItemX03Helmet extends ItemArmor implements IPowerArmor {
        ...
        public ModelBiped getArmorModel(EntityLivingBase living, ItemStack stack, EntityEquipmentSlot slot, ModelBiped defaultModel) {
            if (helmetModel == null) {
                helmetModel = new PowerArmorModel(0, "x03", false, false);
            }
            return helmetModel;
        }
        ...
        public ModelBiped getArmorModel(EntityLivingBase living, ItemStack stack, EntityEquipmentSlot slot, ModelBiped defaultModel) {
            ...
            if (jetpack) {
                if (chestplateModelJet == null) {
                    chestplateModelJet = new PowerArmorModel(1, "x03", true, false);
                }
                return chestplateModelJet;
            } else {
                if (chestplateModel == null) {
                    chestplateModel = new PowerArmorModel(1, "x03", false, false);
                }
    ...
    public class ItemX03Leggings extends ItemArmor implements IPowerArmor {
        ...
        public ModelBiped getArmorModel(EntityLivingBase living, ItemStack stack, EntityEquipmentSlot slot, ModelBiped defaultModel) {
            if (leggingsModel == null) {
                leggingsModel = new PowerArmorModel(2, "x03", false, false);
            }
    ...
    public class ItemX03Boots extends ItemArmor implements IPowerArmor {
        ...
        public ModelBiped getArmorModel(EntityLivingBase living, ItemStack stack, EntityEquipmentSlot slot, ModelBiped defaultModel) {
            if (bootsModel == null) {
                bootsModel = new PowerArmorModel(3, "x03", false, false);
            }
            return bootsModel;
        }
