...
public class ArmorT60 extends ModElementRegistry.ModElement {
    ...
    public void registerModels(ModelRegistryEvent event) {
        ...
        ModelLoader.setCustomModelResourceLocation(leggings, 0, new ModelResourceLocation("afp:t60/t60_leggings", "inventory"));
        ...
        ModelLoader.setCustomMeshDefinition(chestplate, stack -> {
            ...
            String modelPath = jetpack ? "afp:t60/t60_chestplate_jetpack" : "afp:t60/t60_chestplate";
        ...
        ModelLoader.registerItemVariants(
                ...
                new ModelResourceLocation("afp:t60/t60_chestplate_jetpack", "inventory")
        );
    }
    ...
    public class ItemT60Helmet extends ItemArmor implements IPowerArmor {
        ...
        public ModelBiped getArmorModel(EntityLivingBase living, ItemStack stack, EntityEquipmentSlot slot, ModelBiped defaultModel) {
            if (helmetModel == null) {
                helmetModel = new PowerArmorModel(0, "t60", false, false);
            }
            return helmetModel;
        }
        ...
        public ModelBiped getArmorModel(EntityLivingBase living, ItemStack stack, EntityEquipmentSlot slot, ModelBiped defaultModel) {
            ...
            if (jetpack) {
                if (chestplateModelJet == null) {
                    chestplateModelJet = new PowerArmorModel(1, "t60", true, false);
                }
                return chestplateModelJet;
            } else {
                if (chestplateModel == null) {
                    chestplateModel = new PowerArmorModel(1, "t60", false, false);
                }
    ...
    public class ItemT60Leggings extends ItemArmor implements IPowerArmor {
        ...
        public ModelBiped getArmorModel(EntityLivingBase living, ItemStack stack, EntityEquipmentSlot slot, ModelBiped defaultModel) {
            if (leggingsModel == null) {
                leggingsModel = new PowerArmorModel(2, "t60", false, false);
            }
    ...
    public class ItemT60Boots extends ItemArmor implements IPowerArmor {
        ...
        public ModelBiped getArmorModel(EntityLivingBase living, ItemStack stack, EntityEquipmentSlot slot, ModelBiped defaultModel) {
            if (bootsModel == null) {
                bootsModel = new PowerArmorModel(3, "t60", false, false);
            }
            return bootsModel;
        }
