...
public class ArmorT45Broken extends ModElementRegistry.ModElement {

    @GameRegistry.ObjectHolder("afp:t45_helmet_broken")
    public static final Item helmet = null;
    @GameRegistry.ObjectHolder("afp:t45_chestplate_broken")
    public static final Item chestplate = null;
    @GameRegistry.ObjectHolder("afp:t45_leggings_broken")
    public static final Item leggings = null;
    @GameRegistry.ObjectHolder("afp:t45_boots_broken")
    ...
    public ArmorT45Broken(ModElementRegistry instance) {
        super(instance, 13);
    }

    @Override
    public void initElements() {
        AFPConfig.ArmorSet config = AFPConfig.getArmorSet("T45");
        ...
        elements.items.add(() -> new ItemT45Helmet(enuma, 0, EntityEquipmentSlot.HEAD)
                .setTranslationKey("t45_helmet_broken")
                .setRegistryName("t45_helmet_broken")
                .setCreativeTab(TabPowerArmor.tab));

        elements.items.add(() -> new ItemT45Chestplate(enuma, 0, EntityEquipmentSlot.CHEST)
                .setTranslationKey("t45_chestplate_broken")
                .setRegistryName("t45_chestplate_broken")
                .setCreativeTab(TabPowerArmor.tab));

        elements.items.add(() -> new ItemT45Leggings(enuma, 0, EntityEquipmentSlot.LEGS)
                .setTranslationKey("t45_leggings_broken")
                .setRegistryName("t45_leggings_broken")
                .setCreativeTab(TabPowerArmor.tab));

        elements.items.add(() -> new ItemT45Boots(enuma, 0, EntityEquipmentSlot.FEET)
                .setTranslationKey("t45_boots_broken")
                .setRegistryName("t45_boots_broken")
                .setCreativeTab(TabPowerArmor.tab));
    }
    ...
    public void registerModels(ModelRegistryEvent event) {
        ModelLoader.setCustomModelResourceLocation(helmet, 0, new ModelResourceLocation("afp:t45/t45_helmet_broken", "inventory"));
        ModelLoader.setCustomModelResourceLocation(chestplate, 0, new ModelResourceLocation("afp:t45/t45_chestplate_broken", "inventory"));
        ModelLoader.setCustomModelResourceLocation(leggings, 0, new ModelResourceLocation("afp:t45/t45_leggings_broken", "inventory"));
        ModelLoader.setCustomModelResourceLocation(boots, 0, new ModelResourceLocation("afp:t45/t45_boots_broken", "inventory"));
    }
    ...
    public class ItemT45Helmet extends ItemArmor implements IPowerArmor {
        ...
        public ModelBiped getArmorModel(EntityLivingBase living, ItemStack stack, EntityEquipmentSlot slot, ModelBiped defaultModel) {
            if (helmetModel == null) {
                helmetModel = new PowerArmorModel(0, "t45", false, true);
            }
            return helmetModel;
        }
    ...
    public class ItemT45Chestplate extends ItemArmor implements IPowerArmor {
        ...
        public ModelBiped getArmorModel(EntityLivingBase living, ItemStack stack, EntityEquipmentSlot slot, ModelBiped defaultModel) {
            if (chestplateModel == null) {
                chestplateModel = new PowerArmorModel(1, "t45", false, true);
            }
    ...
    public class ItemT45Leggings extends ItemArmor implements IPowerArmor {
        ...
        public ModelBiped getArmorModel(EntityLivingBase living, ItemStack stack, EntityEquipmentSlot slot, ModelBiped defaultModel) {
            if (leggingsModel == null) {
                leggingsModel = new PowerArmorModel(2, "t45", false, true);
            }
    ...
    public class ItemT45Boots extends ItemArmor implements IPowerArmor {
        ...
        public ModelBiped getArmorModel(EntityLivingBase living, ItemStack stack, EntityEquipmentSlot slot, ModelBiped defaultModel) {
            if (bootsModel == null) {
                bootsModel = new PowerArmorModel(3, "t45", false, true);
            }
            return bootsModel;
        }
