...
public class ArmorX01Broken extends ModElementRegistry.ModElement {

    @GameRegistry.ObjectHolder("afp:x01_helmet_broken")
    public static final Item helmet = null;
    @GameRegistry.ObjectHolder("afp:x01_chestplate_broken")
    public static final Item chestplate = null;
    @GameRegistry.ObjectHolder("afp:x01_leggings_broken")
    public static final Item leggings = null;
    @GameRegistry.ObjectHolder("afp:x01_boots_broken")
    ...
    public ArmorX01Broken(ModElementRegistry instance) {
        super(instance, 10);
    }
    ...
    public void initElements() {
        ...
        elements.items.add(() -> new ItemX01Helmet(enuma, 0, EntityEquipmentSlot.HEAD)
                .setTranslationKey("x01_helmet_broken")
                .setRegistryName("x01_helmet_broken")
                .setCreativeTab(TabPowerArmor.tab));

        elements.items.add(() -> new ItemX01Chestplate(enuma, 0, EntityEquipmentSlot.CHEST)
                .setTranslationKey("x01_chestplate_broken")
                .setRegistryName("x01_chestplate_broken")
                .setCreativeTab(TabPowerArmor.tab));

        elements.items.add(() -> new ItemX01Leggings(enuma, 0, EntityEquipmentSlot.LEGS)
                .setTranslationKey("x01_leggings_broken")
                .setRegistryName("x01_leggings_broken")
                .setCreativeTab(TabPowerArmor.tab));

        elements.items.add(() -> new ItemX01Boots(enuma, 0, EntityEquipmentSlot.FEET)
                .setTranslationKey("x01_boots_broken")
                .setRegistryName("x01_boots_broken")
                .setCreativeTab(TabPowerArmor.tab));
    }
    ...
    public void registerModels(ModelRegistryEvent event) {
        ModelLoader.setCustomModelResourceLocation(helmet, 0, new ModelResourceLocation("afp:x01/x01_helmet_broken", "inventory"));
        ModelLoader.setCustomModelResourceLocation(chestplate, 0, new ModelResourceLocation("afp:x01/x01_chestplate_broken", "inventory"));
        ModelLoader.setCustomModelResourceLocation(leggings, 0, new ModelResourceLocation("afp:x01/x01_leggings_broken", "inventory"));
        ModelLoader.setCustomModelResourceLocation(boots, 0, new ModelResourceLocation("afp:x01/x01_boots_broken", "inventory"));
    }
    ...
    public class ItemX01Helmet extends ItemArmor implements IPowerArmor {
        ...
        public ModelBiped getArmorModel(EntityLivingBase living, ItemStack stack, EntityEquipmentSlot slot, ModelBiped defaultModel) {
            if (helmetModel == null) {
                helmetModel = new PowerArmorModel(0, "x01", false, true);
            }
            return helmetModel;
        }
    ...
    public class ItemX01Chestplate extends ItemArmor implements IPowerArmor {
        ...
        public ModelBiped getArmorModel(EntityLivingBase living, ItemStack stack, EntityEquipmentSlot slot, ModelBiped defaultModel) {
            if (chestplateModel == null) {
                chestplateModel = new PowerArmorModel(1, "x01", false, true);
            }
    ...
    public class ItemX01Leggings extends ItemArmor implements IPowerArmor {
        ...
        public ModelBiped getArmorModel(EntityLivingBase living, ItemStack stack, EntityEquipmentSlot slot, ModelBiped defaultModel) {
            if (leggingsModel == null) {
                leggingsModel = new PowerArmorModel(2, "x01", false, true);
            }
    ...
    public class ItemX01Boots extends ItemArmor implements IPowerArmor {
        ...
        public ModelBiped getArmorModel(EntityLivingBase living, ItemStack stack, EntityEquipmentSlot slot, ModelBiped defaultModel) {
            if (bootsModel == null) {
                bootsModel = new PowerArmorModel(3, "x01", false, true);
            }
            return bootsModel;
        }
