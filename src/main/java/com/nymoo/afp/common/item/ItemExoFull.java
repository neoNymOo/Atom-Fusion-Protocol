...
public class ItemExoFull extends ModElementRegistry.ModElement {
    /**
     * Зарегистрированный предмет экзоскелета
     */
    @GameRegistry.ObjectHolder("afp:exo_full")
    public static final Item itemExoskeleton = null;

    public ItemExoFull(ModElementRegistry instance) {
        super(instance, 1);
    }
    ...
    public void registerModels(ModelRegistryEvent event) {
        ModelLoader.setCustomModelResourceLocation(itemExoskeleton, 0, new ModelResourceLocation("afp:exo_full", "inventory"));
    }
    ...
    public static class ItemCustom extends Item {
        public ItemCustom() {
            setMaxDamage(0);
            maxStackSize = 1;
            setTranslationKey("exo_full");
            setRegistryName("exo_full");
