...
public class ArmorX03Broken extends ModElementRegistry.ModElement {

    @GameRegistry.ObjectHolder("afp:x03_helmet_broken")
    public static final Item helmet = null;
    @GameRegistry.ObjectHolder("afp:x03_chestplate_broken")
    public static final Item chestplate = null;
    @GameRegistry.ObjectHolder("afp:x03_leggings_broken")
    public static final Item leggings = null;
    @GameRegistry.ObjectHolder("afp:x03_boots_broken")
    ...
    public ArmorX03Broken(ModElementRegistry instance) {
        super(instance, 8);
    }
    ...
    public void initElements() {
        ...
        elements.items.add(() -> new ItemX03Helmet(enuma, 0, EntityEquipmentSlot.HEAD)
                .setTranslationKey("x03_helmet_broken")
                .setRegistryName("x03_helmet_broken")
                .setCreativeTab(TabPowerArmor.tab));

        elements.items.add(() -> new ItemX03Chestplate(enuma, 0, EntityEquipmentSlot.CHEST)
                .setTranslationKey("x03_chestplate_broken")
                .setRegistryName("x03_chestplate_broken")
                .setCreativeTab(TabPowerArmor.tab));

        elements.items.add(() -> new ItemX03Leggings(enuma, 0, EntityEquipmentSlot.LEGS)
                .setTranslationKey("x03_leggings_broken")
                .setRegistryName("x03_leggings_broken")
                .setCreativeTab(TabPowerArmor.tab));

        elements.items.add(() -> new ItemX03Boots(enuma, 0, EntityEquipmentSlot.FEET)
                .setTranslationKey("x03_boots_broken")
                .setRegistryName("x03_boots_broken")
                .setCreativeTab(TabPowerArmor.tab));
    }
    ...
    public void registerModels(ModelRegistryEvent event) {
        ModelLoader.setCustomModelResourceLocation(helmet, 0, new ModelResourceLocation("afp:x03/x03_helmet_broken", "inventory"));
        ModelLoader.setCustomModelResourceLocation(chestplate, 0, new ModelResourceLocation("afp:x03/x03_chestplate_broken", "inventory"));
        ModelLoader.setCustomModelResourceLocation(leggings, 0, new ModelResourceLocation("afp:x03/x03_leggings_broken", "inventory"));
        ModelLoader.setCustomModelResourceLocation(boots, 0, new ModelResourceLocation("afp:x03/x03_boots_broken", "inventory"));
    }
    ...
    public class ItemX03Helmet extends ItemArmor implements IPowerArmor {
        ...
        public ModelBiped getArmorModel(EntityLivingBase living, ItemStack stack, EntityEquipmentSlot slot, ModelBiped defaultModel) {
            if (helmetModel == null) {
                helmetModel = new PowerArmorModel(0, "x03", false, true);
            }
            return helmetModel;
        }
    ...
    public class ItemX03Chestplate extends ItemArmor implements IPowerArmor {
        ...
        public ModelBiped getArmorModel(EntityLivingBase living, ItemStack stack, EntityEquipmentSlot slot, ModelBiped defaultModel) {
            if (chestplateModel == null) {
                chestplateModel = new PowerArmorModel(1, "x03", false, true);
            }
    ...
    public class ItemX03Leggings extends ItemArmor implements IPowerArmor {
        ...
        public ModelBiped getArmorModel(EntityLivingBase living, ItemStack stack, EntityEquipmentSlot slot, ModelBiped defaultModel) {
            if (leggingsModel == null) {
                leggingsModel = new PowerArmorModel(2, "x03", false, true);
            }
    ...
    public class ItemX03Boots extends ItemArmor implements IPowerArmor {
        ...
        public ModelBiped getArmorModel(EntityLivingBase living, ItemStack stack, EntityEquipmentSlot slot, ModelBiped defaultModel) {
            if (bootsModel == null) {
                bootsModel = new PowerArmorModel(3, "x03", false, true);
            }
            return bootsModel;
        }
