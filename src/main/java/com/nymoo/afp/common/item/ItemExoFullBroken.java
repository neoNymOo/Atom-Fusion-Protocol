...
import com.nymoo.afp.common.entity.EntityExoskeletonBroken;
...
public class ItemExoFullBroken extends ModElementRegistry.ModElement {
    /**
     * Зарегистрированный предмет экзоскелета
     */
    @GameRegistry.ObjectHolder("afp:exo_full_broken")
    public static final Item itemExoskeleton = null;

    public ItemExoFullBroken(ModElementRegistry instance) {
        super(instance, 2);
    }
    ...
    public void registerModels(ModelRegistryEvent event) {
        ModelLoader.setCustomModelResourceLocation(itemExoskeleton, 0, new ModelResourceLocation("afp:exo_full_broken", "inventory"));
    }
    ...
    public static class ItemCustom extends Item {
        public ItemCustom() {
            setMaxDamage(0);
            maxStackSize = 1;
            setTranslationKey("exo_full_broken");
            setRegistryName("exo_full_broken");
        ...
        public EnumActionResult onItemUse(EntityPlayer player, World world, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
            ...
            if (!world.isRemote && player.canPlayerEdit(placementPos, facing, player.getHeldItem(hand))) {
                ...
                if (world.getCollisionBoxes(entity, entity.getEntityBoundingBox()).isEmpty() && world.getEntitiesWithinAABBExcludingEntity(entity, entity.getEntityBoundingBox()).isEmpty()) {
                    entity.setHeldItem(EnumHand.MAIN_HAND, new ItemStack(Item.getByNameOrId("afp:exo_full_broken")));
